...
export default function LandingSection() {
  return (
    <div id="contact" className=" flex flex-col justify-between bg-[#03222D] text-white px-8  py-16">
      {/* Main Content */}
      <div className="flex-1 flex flex-col items-center justify-center max-w-4xl mx-auto text-center">
        <h1 className="text-[34px] md:text-[38px] xl:text-[48px] font-bold mb-6 sm:mb-10 xl:leading-14 leading-11">
        Unlock <span className="text-[#a3e5d9]">your</span> Business Potential and get out of the crowd!!
        </h1>

        <p className="text-base md:text-lg xl:text-xl text-gray-300 mb-12 max-w-2xl">
        Get in touch today, and let’s explore how I can help you achieve your goals.
        </p>

        <a
          href="https://wa.me/918708328865"  target="_blank"
          className="inline-flex items-center text-base px-5 py-4 pl-7 rounded-full bg-[#1C5B6C] hover:bg-[#1C5B6C]/50 hover:text-white transition-colors duration-300"
        >
          Connect on WhastApp <span className="ml-2 text-lg"><FaWhatsapp className="mr-2" /></span>
        </a>
      </div>

      {/* Footer */}
      <div className="w-full max-w-7xl mx-auto mt-16 flex flex-col md:flex-row justify-between items-center gap-6">
